defmodule PracLiveWeb.RatingLive.FormComponent do
    use PracLiveWeb, :live_component
    alias PracLive.Survey
    alias PracLive.Survey.Rating
    ...
    def save_rating(%{assigns: %{game_index: game_index, game: game}} = socket, rating_params) do
